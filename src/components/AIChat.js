      ...
      <CardContent sx={{ flexGrow: 1, overflowY: "auto", maxHeight: "50vh", display: "flex", flexDirection: "column-reverse", bgcolor: "#f9f9f9", padding: 2, borderRadius: 2 }}>
        {messages.length === 0 && (
          <Typography variant="body2" color="textSecondary" sx={{ mb: 2, textAlign: "center" }}>
                   Disclaimer: No information is stored on any server or database. 
                     All conversation history is kept only in your browser’s cache.
                     To delete previous messages, clear your browser’s cache and history. 
                     This service is fully paid for by its anonymous creator, who respects privacy and ensures that it remains free for your use.
              </Typography>
        )}
